    ...
    return (
        <React.Fragment>
            ...
            <main className={styles.main}>
                ...
                <p>
                    If you want to know more about me, just get rid of the <em>/kreuzberg-1//</em> part in the url and you&apos;ll land on my website (which I keep mostly for professional purposes as a developer).
                </p>
            </main>
        </React.Fragment>
    );
