    ...
    return (
		<React.Fragment>
			...
			<main className={styles.main}>
				...
				<h2 className={styles.h2}>1 year from August 2020</h2>
				<hr/>
				<br/>
				<h3 className={styles.h3}>Hi there!</h3>
				<p>
					Lucky you, someone forwarded you this link! Oli here 🐒, I’m subletting my furnished flat in Kreuzberg/Bergmannkiez for a year. It will be available from the <strong>01.08.20</strong> (although I am still rather flexible with the exact date).
				</p>
       ...
       href={flatPicture.relativePath}
        ...
        alt={`Flat Picture ${flatPicture.name}`}
				...
				<p>The flat is <strong>56m<sup>2</sup></strong> and perfect for a couple (you can have it just for yourself as well of course). There&apos;s one bedroom and a larger room which combines the kitchen and living area. It has a nice parquet floor and is amazingly bright.
				</p>
				<p>
	      ...
	      alt="Flat Layout"
            ...
            className={styles.map}
				...
				<p>The exact costs will of course depend on your consumption but you can count about <strong>1.089 €</strong>, all included:
				</p>
				...
				<p>
					If you want to know more about me, just get rid of the <em>/kreuzberg/</em> part in the url and you&apos;ll land on my website (which I keep mostly for my professional purposes as a developer).
				</p>
			</main>
		</React.Fragment>
    );
